...
| 场景 | Clarity 如何帮助 |
|------|------------------|
| **死点击** | 发现用户点击了不可点击的区域，说明用户期望那里有交互 |
| **快速点击** | 用户快速重复点击，可能表示按钮响应慢或没有反馈 |
| **愤怒点击** | 用户连续用力点击，表示极度沮丧 |
| **滚动深度** | 了解用户实际浏览了多少内容 |

##### 2. 优化页面布局

- **热图分析**：发现用户最关注的区域，优化重要内容的放置位置
- **注意力热图**：了解用户在页面各区域停留的时间
- **滚动热图**：确定用户在何处放弃滚动
...
| 工具 | 优势 | 适用场景 |
|------|------|----------|
| **Microsoft Clarity** | 免费、热图、会话录制 | 用户体验优化、问题发现 |
| **Google Analytics** | 流量分析、转化追踪 | 流量来源分析、目标转化 |
| **Hotjar** | 功能更丰富（付费） | 企业级用户研究 |
| **Mixpanel** | 事件追踪、漏斗分析 | 产品数据分析 |
